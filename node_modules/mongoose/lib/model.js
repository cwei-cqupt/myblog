 ...
 *
 * Sometimes you need to query for things in mongodb using a JavaScript expression. You can do so via `find({ $where: javascripts })`, or you can use the mongoose shortcut method $where via a Query chain or from your mongoose Model.
 *
 *     Blog.$where('this.username.indexOf("val") !== -1').exec(function (err, docs) {});
 *
 * @param {String|Function} argument is a javascripts string or anonymous function
 * @method $where
 * @memberOf Model
 * @return {Query}
 ...
 * - The documents returned are plain javascripts objects, not mongoose documents (since any shape of document can be returned).
