...
/**
 * Specifies a javascripts function or expression to pass to MongoDBs query system.
 *
 * ####Example
 *
 ...
 * @method $where
 * @param {String|Function} js javascripts string or function
 * @return {Query} this
 * @memberOf Query
 * @method $where
 * @api public
 ...
 *
 * Documents returned from queries with the `lean` option enabled are plain javascripts objects, not [MongooseDocuments](#document-js). They have no `save` method, getters/setters or other Mongoose magic applied.
 *
 * ####Example:
 *
 *     new Query().lean() // true
